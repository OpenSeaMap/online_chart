<table border="0" cellpadding="5">
	<tr>
		<td><IMG src="resources/lateral/Lateral_SafeWater_Sphere.png" width="30" height="36" align="center" border="0"/></td>
		<td><?=$t->tr("safe_water")?></td>
	</tr>
	<tr>
		<td><IMG src="resources/lateral/Lateral_Green_Conical.png" width="30" height="36" align="center" border="0"/></td>
		<td><?=$t->tr("lateral_starboard")?></td>
	</tr>
	<tr>
		<td><IMG src="resources/lateral/Lateral_Red_Cylindrical.png" width="30" height="36" align="center" border="0"/></td>
		<td><?=$t->tr("lateral_port")?></td>
	</tr>
	<tr>
		<td><IMG src="resources/lateral/Lateral_Pref_Starboard_Conical.png" width="30" height="36" align="center" border="0"/></td>
		<td><?=$t->tr("lateral_pref_starboard")?></td>
	</tr>
	<tr>
		<td><IMG src="resources/lateral/Lateral_Pref_Port_Cylindrical.png" width="30" height="36" align="center" border="0"/></td>
	...
	<tr>
		<td><IMG src="resources/special_purpose/Special_Purpose_x-Shape.png" width="30" height="36" align="center" border="0"/></td>
